document.addEventListener("DOMContentLoaded", function (event) {
  ...
  var tlWork1 = gsap.timeline({
    scrollTrigger: {
      trigger: ".worksproject ul",
      start: "40% bottom",
    },
  });
  tlWork1.staggerFrom(
    ".worksproject .work__hiretext",
    1,
    { y: "100%", ease: Power3.easeOut },
    0.15
  );

  var tlWork2 = gsap.timeline({
    scrollTrigger: {
      trigger: ".works-personal-project ul",
      start: "40% bottom",
    },
  });
  tlWork2.staggerFrom(
    ".works-personal-project .work__hiretext",
    1,
    { y: "100%", ease: Power3.easeOut },
    0.15
  );
